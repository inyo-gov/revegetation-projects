...
transects_by_parcel_year <- ref_data_combined %>%
  ...
  select(reference_group, parcel, Year_2022, Year_2023, Year_2024, Year_2025) %>%
  arrange(reference_group, parcel)

# Print for debugging
print("Fresh calculation completed")
print(paste("2025 values:", paste(transects_by_parcel_year$Year_2025, collapse = ", ")))
