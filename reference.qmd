...
### 1. **Data Ingestion**
- **LAW90/94/95 parcels**: Processed from individual CSV files with 0.5x scaling (200 hits = 100% cover)
- **LAW118/129 parcels**: Processed from Excel files with 1.0x scaling (100 hits = 100% cover)
...
- **Percent cover**: Hits converted to percentage based on transect type (100 or 200 total possible hits)
