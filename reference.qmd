...
- All files are updated with the latest corrected reference parcel analysis
...
ref_file_paths <- c(
  ...
  "data/processed/transect_species_data.csv",
...
download_info <- data.frame(
  ...
  "Last Modified" = sapply(ref_file_paths, get_file_date),
  Download = c(
