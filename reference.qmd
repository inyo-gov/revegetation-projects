  ...
  datatable(
    options = list(
      ...
      columnDefs = list(
        ...
        list(width = '14%', targets = 3),    # species
        list(width = '12%', targets = 4),    # avg_cover
        list(width = '14%', targets = 5),    # avg_perennial_cover
        list(width = '14%', targets = 6),    # avg_relative_cover
        list(width = '16%', targets = 7)     # total_transects
      ),
      dom = 'Bfrtip',
      buttons = c('csv'),
      pageLength = 25
...
atto_erna_summary %>%
  datatable(
    options = list(
      ...
      scrollX = FALSE,
      columnDefs = list(
        list(width = '14%', targets = 0),    # species
        list(width = '16%', targets = 1),    # reference_group
    ...
    colnames = c(
      ...
      "Reference<br/>Parcel Group",
      "Year",
      "Mean Average<br/>Cover %",
      "Standard<br/>Deviation",
      "Mean Relative<br/>Cover %",
...
download_info <- data.frame(
  ...
  Description = c(
    ...
    "Complete reference dataset with all variables (includes transect-level species cover data)"
  ),
  Rows = c(
...
datatable(
  download_info,
    options = list(
      ...
      scrollX = FALSE,
      columnDefs = list(
        list(width = '15%', targets = 0),    # Dataset Name
        list(width = '30%', targets = 1),    # Description
        list(width = '12%', targets = 2),    # Number of Rows
        list(width = '12%', targets = 3),    # Number of Columns
        list(width = '16%', targets = 4),    # Last Modified
