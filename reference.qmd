...
### 1. **Data Ingestion**
- **LAW90/94/95 parcels**: Processed from individual CSV files with 1.0x scaling (100 hits = 100% cover)
...
- **Percent cover**: All reference parcels use 1.0x scaling (100 hits = 100% cover)
