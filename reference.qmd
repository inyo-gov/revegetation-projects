...
#| tbl-colwidths: [15, 8, 12, 12, 12, 12, 12, 12, 5]
...
#| tbl-colwidths: [15, 20, 8, 12, 12, 12, 12, 9]
...
#| tbl-colwidths: [25, 35, 10, 10, 10, 10]
# Load comprehensive reference data
tar_load(ref_data_combined)
...
datatable(
  ...
  options = list(
    ...
    scrollX = TRUE,
    columnDefs = list(
      list(width = '18%', targets = 0),    # Dataset Name
...
**Inyo County Water Department. (2025). *Revegetation Projects Reference Parcel Analysis*. Data Report. Retrieved from https://github.com/inyo-gov/revegetation-projects**
