...
# Create comprehensive data dictionary with download links
data_dictionary <- data.frame(
  ...
  Download = c(
    '<a href="../output/compliance_summary.csv" download>⬇ CSV</a>',
    '<a href="../output/transect_coverage.csv" download>⬇ CSV</a>',
    '<a href="../output/reference_parcel_summary.csv" download>⬇ CSV</a>',
    '<a href="../output/r3_data_analysis.csv" download>⬇ CSV</a>',
    '<a href="../output/all_transects_combined.geojson" download>⬇ GeoJSON</a>',
    '<a href="../output/parcel_boundaries.geojson" download>⬇ GeoJSON</a>'
  )
)
...
datatable(
  ...
  options = list(
    ...
    scrollX = TRUE,
    columnDefs = list(
      list(width = '20%', targets = 0),    # Dataset
      list(width = '40%', targets = 1),    # Description
      list(width = '12%', targets = 2),    # Rows
      list(width = '12%', targets = 3),    # Columns
      list(width = '16%', targets = 4)     # Download
    ),
    pageLength = 20,
    dom = 'Bfrtip',
    buttons = c('csv')
  ...
  extensions = 'Buttons',
  filter = 'top',
  colnames = c("Dataset", "Description", "Rows", "Columns", "Download"),
