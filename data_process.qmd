...
data_dictionary <- data.frame(
  ...
  Description = c(
    "Species summary with average cover per parcel across all years",
    "Filtered parcel-level summaries with perennial cover",
    "Transect-level cover analysis with 2% threshold compliance",
    "Reference parcel statistics and ATTO/ERNA analysis",
    "Core revegetation analysis dataset with species hits",
...
datatable(
  ...
  options = list(
    ...
    scrollX = FALSE,
    columnDefs = list(
      list(width = '15%', targets = 0),    # Dataset
...
::: {.alert .alert-warning .alert-disclaimer}
