...
datatable(
  ...
  colnames = c(
    "Parcel", "Year", 
    "Cover ≥10%<br/>(Full)", "Cover ≥10%<br/>(Capped)", "Cover ≥10%<br/>(Original)",
...
#| tbl-colwidths: [20, 15, 15, 15, 15, 20]
...
datatable(
  ...
  options = list(
    ...
    columnDefs = list(
      ...
      list(width = '16%', targets = 1:5)   # other columns
    ),
    dom = 'Bfrtip',
    buttons = c('csv'),
    pageLength = 10
  ...
  colnames = c(
    ...
    "ATTO<br/>Average Cover", 
    "ERNA10<br/>Average Cover", 
    "Combined<br/>ATTO+ERNA10", 
    "Total<br/>Transects",
    "Policy<br/>Implementation Cap"
  )
)
```
